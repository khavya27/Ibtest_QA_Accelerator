...
class PytestReportGenerator:
    ...
    def __init__(
        ...
        detailed: bool = False,
        report_title: Optional[str] = "Test Execution Summary",
    ):
        self.results_file = Path(results_file)
        self.report_title = report_title
        self.output_file = (
            Path(output_file) if output_file else self.results_file.parent / "SMBC-IntelliTest_test_summary.pdf"
        )
    ...
    def generate_report(self):
        ...
        elements.append(Paragraph(self.report_title, centered_title))
...
def main():
    ...
    parser.add_argument(
        "--report-title", dest="report_title", type=str, help="Report title", default="Test Execution Report"
    )
    args = parser.parse_args()
    # debug-print to confirm what you actually received
    print("argv:", repr(__import__("sys").argv))
    print("report_title:", repr(args.report_title))
    report_title = args.report_title if str(args.report_title).strip() != "" else "Test Execution Summary"

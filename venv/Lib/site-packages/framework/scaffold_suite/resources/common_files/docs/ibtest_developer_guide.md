...
# Creates basic sample test suite to run locally/github actions workflow along with configuration files.
infobeans-qai setup --app appname --scaffold true

# Creates full template with all test suites (UI, API, DB tests, helpers, utils, test data).
...
```yaml
# config.yaml
# Automation Suite Specific Configs as your suite.

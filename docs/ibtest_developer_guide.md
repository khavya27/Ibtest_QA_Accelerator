...
# Creates sample test tests to run locally/github actions workflow along with configuration files.
ibtest setup --app appname --scaffold true 

# Creates bare minimum configuration and a test files along with github actions workflow files.
...
```yaml
# config.yaml
# Automation Suite Specific Configs as your tests.
